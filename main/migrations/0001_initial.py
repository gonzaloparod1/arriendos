# Generated by Django 5.0.6 on 2024-10-13 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_file', models.ImageField(null=True, upload_to=main.models.generar_nombre_aleatorio)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='inmueble', to='main.imagen')),
                ('propietario', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='inmueble', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='comuna',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('rezachaza', 'Rechazada'), ('aprobada', 'Aprobada')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('arrendatario', 'Arrendatario'), ('arrendador', 'Arrendador'), ('admin', 'Admin')], default='arrendatario', max_length=50)),
